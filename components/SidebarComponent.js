...
export default function SidebarComponent() {
    ...
    const buttonIconClassName = "text-3xl m-3"
    ...
    return (
        <div className="border border-slate-200 bg-white h-screen p-4 py-4 w-90 dark:border-none dark:bg-black">
            <div className="flex flex-col h-full gap-6 rounded-3xl dark:bg-black">
                <h1 className="dark:text-white mt-4 text-3xl text-center font-bold text-gray-900 w-full">
                    StreamSwap
                </h1>
                ...
                <div className="my-2 w-full flex flex-col gap-4">
                    ...
                    <Link href="" className={buttonGroup}>
                        ...
                        >
                            {toggle ? (
                                <div>
                                    <RiSunLine className="text-3xl m-2 ml-3 mr-3"></RiSunLine>
                                </div>
                            ) : (
                                <div>
                                    <BsMoon className="text-2xl m-2 ml-4 mr-3.5"></BsMoon>
                                </div>
                            )}
